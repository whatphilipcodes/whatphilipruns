...
download_if_missing "/weights/generation/tokenizer_config.json" "https://huggingface.co/HuggingFaceTB/SmolLM2-1.7B-Instruct/resolve/main/tokenizer_config.json"
download_if_missing "/weights/generation/tokenizer.json" "https://huggingface.co/HuggingFaceTB/SmolLM2-1.7B-Instruct/resolve/main/tokenizer.json"
download_if_missing "/weights/generation/config.json" "https://huggingface.co/HuggingFaceTB/SmolLM2-1.7B-Instruct/resolve/main/config.json"
download_if_missing "/weights/generation/model_q4.onnx" "https://huggingface.co/HuggingFaceTB/SmolLM2-1.7B-Instruct/resolve/main/onnx/model_q4.onnx"
